 ...
 */
public class NotMyAwardsAdapter extends BaseAdapter {

    private ArrayList<NotMyAwards> alist = new ArrayList<NotMyAwards>();

    public NotMyAwardsAdapter(){}
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        NotMyAwards notMyAwards = alist.get(position);

        txtAward_name.setText(notMyAwards.getAward_name() + " 어워드");
        txtAward_num.setText(notMyAwards.getAward_num());
    ...
    public void addItem(String name, String num){
        ...
        NotMyAwards item = new NotMyAwards();
