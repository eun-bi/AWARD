...
public class AwardsDetailActivity extends AppCompatActivity {
    ...
    class AwardDetailAsync extends AsyncTask<String, String, JSONObject> {

        private static final String urlString = Award.AWARD_URL + "Award_server/Award/mypage_badgeDetail.jsp";
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            try{
                ...
                String award_list = json.getString("award_list");
                Log.i("시상?",award_list);

                JSONObject jo = new JSONObject(award_list);
                ...
                for(int i=0;i<jo.length();i++) {
                        ...
                        Drawable drawable = LoadImage(award_img);
